...
public class SearchCommand extends Command {
    ...
    {
        setDescription("Search for IDs of items, monsters, maps");
    ...
    public void execute(MapleClient c, String[] params) {
        ...
        if (params.length < 2) {
            player.yellowMessage("Usage: !search <type> <name>");
            return;
        }
        ...
        if (!params[0].equalsIgnoreCase("ITEM")) {
            ...
            if (params[0].equalsIgnoreCase("NPC")) {
                ...
                sb.append("#bInvalid search.\r\nUsage: '!search [type] [name]', where [type] is MAP, QUEST, NPC, ITEM, MOB, or SKILL.");
            }
            if (data != null) {
                String name;
