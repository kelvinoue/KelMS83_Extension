            ...
            cm.dispose();
                ...
                if(eim.getProperty(stage.toString() + "stageclear") != null) {
                        ...
                        if (eim.isEventLeader(cm.getPlayer())) {
                                ...
                                if(state == -1) {           // preamble
                                        cm.sendOk("Hi. Welcome to #bStage " + stage + "#k. You will need ranged classes here. They must kill the three Ratz, which will trigger something. What's next is for you to find out! Get me 3 passes!");
                                        eim.setProperty("statusStg" + stage, 0);
                                }
                                else if(state == 0) {       // check stage completion
                                        if (cm.haveItem(4001022, 3)) {
                                                cm.sendOk("Good job! You have collected 3 #b#t4001022#.#k");
                                                cm.gainItem(4001022, -3);

                                                eim.setProperty("statusStg" + stage, 1);
                                                clearStage(stage, eim, curMap);
                                        } else {
                                                cm.sendNext("Sorry you don't have 3 #b#t4001022#.#k");
                                        }
                                }
                        } else {
