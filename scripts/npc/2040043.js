            ...
            cm.dispose();
                ...
                if(eim.getProperty(stage.toString() + "stageclear") != null) {
                        ...
                        if (eim.isEventLeader(cm.getPlayer())) {
                                ...
                                if(state == -1) {           // preamble
                                        cm.sendOk("Hi. Welcome to #bStage " + stage + "#k. In this stage, have 5 members of your party stand on those boxes in order to form the right combination to unlock the next stage. Only one player should stand on each box.");
