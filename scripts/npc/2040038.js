            ...
            cm.dispose();
                ...
                if(eim.getProperty(stage.toString() + "stageclear") != null) {
                        ...
                        if (eim.isEventLeader(cm.getPlayer())) {
                                ...
                                if(state == -1) {           // preamble
                                        cm.sendOk("Hi. Welcome to #bStage " + stage + "#k. Collect 32 #t4001022# scattered across the map, then talk to me.");
                                        eim.setProperty("statusStg" + stage, 0);
                                }
                                else {       // check stage completion
                                        if (cm.haveItem(4001022, 32)) {
                                                cm.sendOk("Good job! You have collected 32 #b#t4001022#.#k");
                                                cm.gainItem(4001022, -32);

                                                eim.setProperty("statusStg" + stage, 1);
                                                clearStage(stage, eim, curMap);
                                        } else {
                                                cm.sendNext("Sorry you don't have 32 #b#t4001022#.#k");
                                        }
                                }
                        } else {
